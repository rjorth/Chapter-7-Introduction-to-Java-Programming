...
public class EightQueens {
	...
	public static int placeOneQueen() {
		
		return(int) (Math.random() * 64); 
	}
	public static boolean isAttacking(char[] board) {
		
		return isSameRow(board) || isSameColumn(board) || isDiagonal(board); 
	...
	public static boolean isDiagonal(char[] board) {
